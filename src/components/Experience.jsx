...
function FactsRail() {
  ...
  return (
    <aside className="order-first self-start lg:order-none">
      {/* Desktop sticky telemetry rail / Mobile compact stat grid */}
      <div className="lg:sticky lg:top-28 rounded-2xl border border-white/10 bg-surface/70 p-5 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
        ...
        <div className="mt-5 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2.5 sm:grid-cols-2 lg:grid-cols-1">
...
export default function Experience() {
  return (
    <section id="experience" className="relative border-t border-white/10 bg-paper/90 py-24">
      ...
      <div className="mx-auto max-w-5xl px-6">
        ...
        <article className="mt-12 grid grid-cols-1 gap-10 lg:grid-cols-[minmax(0,1fr)_280px]">
          <div className="min-w-0">
            {/* Role Header */}
            <div className="rounded-2xl border border-white/10 bg-surface/50 p-6 sm:p-8 backdrop-blur-sm">
            ...
            <div className="mt-10">
              ...
              <div className="mt-6 space-y-4">
                {winbold.problems.map((p, idx) => (
                  <div
                    key={p.heading}
                    className="group rounded-xl border border-white/10 bg-surface/60 p-5 transition-all duration-200 hover:border-cyan-500/40 hover:bg-surface/80"
                  >
        ...
        <article className="mt-16 rounded-2xl border border-white/10 bg-surface/40 p-6 sm:p-8 backdrop-blur-sm transition-all hover:border-white/20">
          <div className="flex flex-wrap items-center justify-between gap-2">
